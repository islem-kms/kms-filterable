...
After installing the Eloquent Filter library, register the `IslemKms\EloquentFilter\ServiceProvider::class` in your `config/app.php` configuration file:

```php
'providers' => [
    // Other service providers...

    IslemKms\EloquentFilter\ServiceProvider::class,
],
```
...
```bash
php artisan vendor:publish --provider="IslemKms\EloquentFilter\ServiceProvider"
```
...
> Only available if you have registered `IslemKms\EloquentFilter\ServiceProvider::class` in the providers array in your `config/app.php'
